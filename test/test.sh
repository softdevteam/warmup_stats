...
./bin/plot_krun_results --with-outliers --with-changepoint-means test/example1_outliers_w200_changepoints.json.bz2 -o test/plots1.pdf
./bin/plot_krun_results --with-outliers --with-changepoint-means test/example2_outliers_w200_changepoints.json.bz2 -o test/plots2.pdf
